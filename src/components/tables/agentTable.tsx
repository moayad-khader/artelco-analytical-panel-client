...
const Main: FC<Props> = ({
    ...
    return (
        <section className="relative h-full dark:bg-background-secondary-dark ">

            <div className="relative mx-auto  min-h-full h-full overflow-auto max-h-full border-2 dark:border-gray-800 dark:background-secondary-dark ">
                                        ...
                                        <tr key={table_id + "_row_" + rowIndex} className="border-b-2 dark:border-gray-800 ">
                                            ...
                                            </td>
                                            {
                                                tableHead.slice(3, tableHead.length).map((cell, cellIndex) =>
                                                    <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap text-center  dark:border-gray-800 dark:bg-background-secondary-dark dark:text-white" key={table_id + "_cell_" + rowIndex + cellIndex}>{row[cell]}</td>
